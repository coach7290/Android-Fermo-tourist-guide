...
/**
 * Main Activity with fragments browsing
 *
...
public class MainActivity extends AppCompatActivity {
    ...
    private void SetupTabbedContent() {
        ...
        if (viewPager != null) {
            ...
            adapter.addFragment(AttrListFragment.newInstance(AttrType.HERITAGES), getString(R.string.visit_tab_title));
            adapter.addFragment(AttrListFragment.newInstance(AttrType.FOOD), getString(R.string.eat_tab_title));
            adapter.addFragment(AttrListFragment.newInstance(AttrType.DRINKS), getString(R.string.drink_tab_title));
            adapter.addFragment(AttrListFragment.newInstance(AttrType.HOTELS), getString(R.string.sleep_tab_title));
